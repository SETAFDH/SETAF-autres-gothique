...
- Version `1.0`: Sonia Solfrini, _Données OCR et segmentation des imprimés de Wygand Koeln et autres (projet SETAF)_, version `1.0`, Genève, université de Genève, 2025, https://github.com/SETAFDH/SETAF-autres-romain.
